...
export const Projects = async () => {
  const projects = await fetchUserRepositories();
...
const Project = ({ project }: { project: RepositoryData }) => {
  return (
    <a
      ...
      className="bg-base rounded-xl border-2 border-mantle/60 focus:outline-none focus:ring-1 focus:ring-blue ring-offset-0 shadow-xl hover:shadow-2xl hover:scale-105 p-3"
    >
